...
public:
	...
	BOOL Open(const WCHAR *pszFileName, const OpenMode enMode, const CharCode enCharCode = _PENDING);
	BOOL Close();
...
public:
	...
	static BOOL UnlinkFolder(const WCHAR *pszPath, const BOOL bParentUnlink);
protected:
